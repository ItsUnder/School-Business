(function () {
  ...
  function updatePortugueseBadge() {
    ...
    // Se enviou a atividade, remove a notificação
  ...
  // Atualiza sempre que entrar no Mural (Framework7)
  ...
  // Também quando a página volta a aparecer (voltar do Português, por ex.)
  ...
  // Atualiza na hora quando mandar upload no Português
